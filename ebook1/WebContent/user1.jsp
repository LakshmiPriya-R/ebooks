...
public static File makefile(String name, int pS,int pE,int n)throws IOException
{
	...
	ContentDoc.save("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/Result"+Integer.toString(n)+".pdf");
	System.out.println("Printing extracted contents.pdf");
	ContentDoc.close();
	File file = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/Result"+Integer.toString(n)+".pdf");
	doc.close();
	return file;
}
%>
...
public static void Merge(ArrayList<File>docs) throws IOException
{
	...
	PDFmerger.setDestinationFileName("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/Merged.pdf");
	int i;
...
File inputFile = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/test.xml");
...
for(int i =0;i<nList.getLength();i++)
{
	...
	String path = "/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/pub_books/"+name+".pdf";
...
StreamResult streamResult = new StreamResult(new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/test.xml"));
transformer.transform(domSource, streamResult);

DOMSource source = new DOMSource(doc);

String qry1 = "for $x in doc('/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/test.xml')/books return $x/customtitle/text()";
...
String intername = "/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/temp.pdf";
while (result.next()) 
{
	customname = result.getItemAsString(null);
	System.out.println(customname);

   	customtitle = "/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/"+customname+".pdf";
}
...
if(nList.getLength() > 1)
{
	Merge(arrFile);
	//File newfile = new File(customtitle);
	File oldfile = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/Merged.pdf");
	oldfile.renameTo(interfile);
	for(int i=0;i<nList.getLength();i++)
	{
		File deletefile = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/Result"+Integer.toString(i)+".pdf");;
		deletefile.delete();
	}
}
else
{
	//File newfile = new File(customtitle);
	File oldfile = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/Result0.pdf");
	oldfile.renameTo(interfile);
}
File newxml = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/"+customname+".xml");
inputFile.renameTo(newxml);

File xmlfile = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/"+customname+".xml");
File xsltfile = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/books.xsl");
File pdffile = new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/custom_books/ResultPDF.pdf");

FopFactory fopFactory = FopFactory.newInstance(new File("/Users/laasya/Desktop/College/sem6/Data Modelling/new/project_data/fop.xconf"));
